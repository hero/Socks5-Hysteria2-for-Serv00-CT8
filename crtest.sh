...
FILE_PATH="${HOME}/.s5"
HYSTERIA_WORKDIR="${HOME}/.hysteria"
...
PM2_PATH="${HOME}/.npm-global/lib/node_modules/pm2/bin/pm2"
CRON_JOB="*/12 * * * * $PM2_PATH resurrect >> ${HOME}/pm2_resurrect.log 2>&1"
...
if command -v pm2 > /dev/null 2>&1 && [[ $(which pm2) == "${HOME}/.npm-global/bin/pm2" ]]; then
